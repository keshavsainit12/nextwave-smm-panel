...
import { AdminTransactionStats } from "@/components/admin/admin-transaction-stats"
import { AdminTransactionTable, AdminDepositTable } from "@/components/admin/admin-transaction-tables"
      ...
      <Card>
        ...
        <CardContent>
          <div className="overflow-x-auto">
            {orders && orders.length > 0 ? (
              <AdminTransactionTable orders={orders} />
            ) : (
            ...
            {((cryptoDeposits && cryptoDeposits.length > 0) || (instantPayments && instantPayments.length > 0)) ? (
              <>
                {cryptoDeposits && cryptoDeposits.length > 0 && (
                  <AdminDepositTable deposits={cryptoDeposits} type="crypto" />
                )}
                {instantPayments && instantPayments.length > 0 && (
                  <AdminDepositTable deposits={instantPayments} type="instant" />
                )}
              </>
            ) : (
